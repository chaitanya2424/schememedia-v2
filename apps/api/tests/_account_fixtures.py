"""Shared fixtures for the auth/profile/saved-schemes/authenticated-
recommendations HTTP test files (test_auth_routes.py,
test_profile_routes.py, test_saved_schemes_routes.py,
test_recommendations_me_routes.py).
...
_TRUNCATE_EVERYTHING = text(
    ...
    "users, refresh_tokens, user_profiles, scheme_saves CASCADE"
)
_TRUNCATE_ACCOUNT_TABLES = text(
    "TRUNCATE users, refresh_tokens, user_profiles, scheme_saves CASCADE"
)
